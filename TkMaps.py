...
evedispath = '/data/users/abakshi/'
tkrunspath = '/data/users/abakshi/TkCommissioner_runs/'
...
for i in range(len(Run_Number)):                                                           
    ...
    File_Name = Ext_functions.downloadOfflineDQMhisto(Run_Number[i], Run_type, rereco)
    ...
    globalTag = Ext_functions.getGT(filepath+File_Name, str(Run_Number[i]), 'globalTag_Step1')          #After switching production to 10_X_X release, the clean up section needs to be reviewed and modified ??
