...
#       CreateSummary            = cms.untracked.bool(False),
    ...
    cms.PSet(mapName=cms.untracked.string('NumberOfCluster'),TopModules=cms.untracked.bool(True),numberTopModules=cms.untracked.int32(-1),RunNumber=cms.untracked.uint32(options.runNumber),mapMax=cms.untracked.double(8.)),
